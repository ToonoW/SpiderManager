...
![er](https://ws2.sinaimg.cn/large/006tNc79gy1fivt72vm9xj30hy09q74q.jpg)
...
| 字段名     | 数据类型         | 选项   | 备注      |
| ------- | ------------ | ---- | ------- |
| action  | varchar(45)  | NN   | 记录日志的行为 |
| message | Varchar(255) | NN   | 日志信息    |
|         |              |      |         |
...
| 函数名      | 中文名           | 备注                           |
| -------- | ------------- | ---------------------------- |
| add_node | 增加Scrapyd节点信息 | 验证输入是否符合数据表要求，在Scrapyd表增加新条目 |
|          |               |                              |
|          |               |                              |
...
| 函数名              | 中文名           | 备注   |
| ---------------- | ------------- | ---- |
| scrapyd_add_node | 增加Scrapyd节点信息 | 权限控制 |
|                  |               |      |
|                  |               |      |
